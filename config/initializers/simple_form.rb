...
SimpleForm.setup do |config|
  ...
  config.wrappers :reservation_form_checkbox, :tag => 'div', :class => 'fi', :error_class => 'error' do |b|
    b.use :placeholder
    b.wrapper :tag => 'div', :class => 'controls' do |ba|
      ba.use :label_input, :wrap_with => {:class => 'checkbox inline'}
      ba.use :error, :wrap_with => {:tag => 'span', :class => 'help-inline'}
  ...
  config.wrappers :reservation_form, :tag => 'div', :class => 'fi', :error_class => 'error' do |b|
    b.use :placeholder
    b.use :label
    b.wrapper :tag => 'div', :class => 'controls' do |ba|
      ba.use :input
