...
#-----------------------------------------------------------------------------
# Cancan ability for regular users
#
class Ability
  ...
  def initialize(user)
    ...
    # the user permission to do. If you pass :manage it will apply
    # to every action. Other common actions here are
    # :read, :create, :update and :destroy.
    #
    # The second argument is the resource the user can perform the action
    # on. If you pass :all it will apply to every resource. Otherwise pass
    # a Ruby class of the resource.
    #
